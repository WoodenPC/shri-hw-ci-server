...
У билд сервера и билд агента нету тестов и не настроены пермишенны + иногда бывают разные ошибки. Также не весь лог красится. Появилось дублирование кода + не настроен докер для билд агента и билд сервера
